...
Understøtter flere Zigbee2MQTT områder (zigbee2mqtt, zigbee2mqtt_area2-6)

ÆNDRINGER:
- Bruger power_meters.mqtt_topic i stedet for meter_readings.base_topic
- Virker automatisk med alle områder uden kode ændringer
- Ingen afhængighed af base_topic felt
"""
