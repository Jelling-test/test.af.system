  ...
  public: {
    Tables: {
      ...
      plugin_data: {
        ...
        Relationships: [
          {
            foreignKeyName: "plugin_data_organization_id_fkey"
      ...
      user_memberships: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_memberships_invited_by_fkey"
            columns: ["invited_by"]
            isOneToOne: false
    ...
    Functions: {
      cleanup_old_forbrug_historik: { Args: never; Returns: undefined }
