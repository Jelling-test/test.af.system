                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  ...
                  <Card className="text-center">
                    ...
                    <CardContent className="space-y-1">
                      <div className="text-3xl font-bold">{customerDetails.meterReading.power.toFixed(1)} W</div>
                      <p className="text-sm text-muted-foreground">
                        {customerDetails.meterReading.current.toFixed(2)} A
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="text-center">
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold">{customerDetails.meterReading.voltage.toFixed(0)} V</div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="text-center">
                    ...
                    <CardContent className="space-y-2">
                      <div className="text-3xl font-bold">{customerDetails.meterReading.energy.toFixed(2)} kWh</div>
                      <Badge variant={customerDetails.meterReading.linkquality > 80 ? "default" : "destructive"}>
                        Signal: {customerDetails.meterReading.linkquality}
                      </Badge>
                    </CardContent>
                  </Card>
                </div>
